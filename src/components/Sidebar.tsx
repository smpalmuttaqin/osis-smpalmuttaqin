...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-68 bg-white border-r border-slate-200 flex flex-col h-screen shrink-0 select-none z-30 transition-all duration-200 font-sans">
      ...
      {/* 4. Bottom Footer: User Info & Quick Role Switcher */}
      <div className="p-3 border-t border-slate-200 bg-slate-50/60 space-y-2 shrink-0">
        {/* User Card */}
        ...
        {/* Role Switcher (for fast testing user roles) */}
        <div className="space-y-1">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block px-1 flex items-center justify-between">
            <span>Uji Hak Akses Role:</span>
          ...
          <div className="relative">
            <select
              ...
              className="w-full text-xs bg-white text-slate-800 border border-slate-200 rounded-lg py-1.5 px-2.5 pr-8 appearance-none focus:outline-none focus:ring-1 focus:ring-blue-500 font-medium cursor-pointer shadow-2xs"
            >
              <option value="seleksi">Role Seleksi (Hanya Bilik Seleksi)</option>
              <option value="pemilihan">Role Pemilihan (Hanya Bilik Suara)</option>
              <option value="guru">Role Guru (Bisa Semua Kecuali Admin)</option>
              <option value="admin">Role Admin (Akses Penuh Semua Menu)</option>
            </select>
